    ...
    <section className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] p-4 gap-4">
      ...
      <div>
        ...
        <div className="mt-4 bg-white p-4 rounded-md">
          <h2>Teacher&lsquo;s Schedule</h2>
          <BigCalender />
        </div>
      </div>
      {/* Right */}
      <div className="">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 mb-4 flex flex-wrap gap-2 text-xs text-gray-500">
            <Link className="p-2 rounded-md bg-sky" href="/list/teachers">
              Teacher&lsquo;s Classes
            </Link>
            <Link className="p-2 rounded-md bg-skyLight" href="/list/teachers/new">
              Add New Students
            </Link>
            <Link className="p-2 rounded-md bg-purple" href="/list/teachers/schedule">
              Teacher&lsquo;s Lessons
            </Link>
            <Link className="p-2 rounded-md bg-purpleLight" href="/list/teachers/attendance">
              Teacher&lsquo;s Attendance
            </Link>
            <Link className="p-2 rounded-md bg-yellow" href="/list/teachers/payments">
              Teacher&lsquo;s Exams
            </Link>
            <Link className="p-2 rounded-md bg-yellowLight" href="/list/teachers/payments">
              Teacher&lsquo;s Assignments
            </Link>
          </div>
        </div>
        <div className="my-4">
